...
namespace Tests.Year2019.IntCodeMachineTests
{
    public class IntCodeMachineTests
    {
        ...
        {
            // Arrange
            var computer = new IntCodeMachine(initialState, new[] { input });
        ...
        {
            // Arrange
            var computer = new IntCodeMachine(initialState, new[] { 12345 });
