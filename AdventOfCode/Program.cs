...
ISolvable? solution = year switch
{
    ...
    2021 => day switch
    {
        ...
        2 => new AdventOfCode.Year2021.Day2.Solution(puzzle),
        3 => new AdventOfCode.Year2021.Day3.Solution(puzzle),
        4 => new AdventOfCode.Year2021.Day4.Solution(puzzle),
    ...
    2022 => day switch
    {
        ...
        2 => new AdventOfCode.Year2022.Day2.Solution(puzzle),
        3 => new AdventOfCode.Year2022.Day3.Solution(puzzle),
        4 => new AdventOfCode.Year2022.Day4.Solution(puzzle),
        5 => new AdventOfCode.Year2022.Day5.Solution(puzzle),
        6 => new AdventOfCode.Year2022.Day6.Solution(puzzle),
        7 => new AdventOfCode.Year2022.Day7.Solution(puzzle),
    ...
    2024 => day switch
    {
        1 => new AdventOfCode.Year2024.Day1.Solution(puzzle),
        _ => null
    },
    _ => null
};
...
if (solution != null)
{
    ...
    {
        Console.WriteLine("No solution for Part 1");
    }
    ...
    {
        Console.WriteLine("No solution for Part 2");
    }
}
else
{
